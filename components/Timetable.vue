<template>
   <div class = "timetable">
      ...
      <p class = "traininfo">{{set[i].min,set[i].kind,set[i].going}}</p>
      <p class = "lineinfo1">{{object1.station,object1.line,object1.going}}</p>
      <p class = "traininfo1">{{set1[i].min,set1[i].kind,set1[i].going}}</p>
...
export default {
    ...
    computed : {
        object : function() {
            ...
            if(dayOfWeek = 6){
                const params = {file : 'weekenddays_22900_1532076033115.json'};
    ...
    object1 : function(){
        function VernalEquinox(year){
            ...
            if(dayOfWeek = 6){
                const params1 = {file : 'weekenddays_22900_1532076061582.json'};
                   axios.get('/timetable',{ params1 })
                    .then((res) =>{
                        var o = new Object();
                    o = JSON.parse(res);
                    });
            ...
            || (month == 10 && dayOfWeek == 1 && 7 < day && day < 15)
            || (SubstituteHoliday() == true)){
                const params1 = {file : 'holidays_22900_1532075792594.json'};
                    axios.get('/timetable',{ params1 })
                    .then((res) =>{
                       var o1 = new Object();
                    o1 = JSON.parse(res);
                ...
                const params1 = {file : 'weekdays_22900_1532075866616.json'};
                    axios.get('/timetable',{ params1 })
                    .then((res) =>{
                         var o1 = new Object();
                    o1 = JSON.parse(res);
